...
class ProviderTestEnvCommand extends AbstractObjectCommand {

    protected function configure() {
      $this->setName('provider:testenv')
        ->setDescription('Uploads a provider into the current test environment.')
    ...
    private function upload(OutputInterface $output) {
      ...
      try {
        $this->validator->validateAsProvider(file_get_contents($this->phpFileName));
