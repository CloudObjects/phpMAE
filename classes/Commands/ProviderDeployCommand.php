...
class ProviderDeployCommand extends AbstractObjectCommand {

  protected function configure() {
    $this->setName('provider:deploy')
      ->setDescription('Validates a provider class for the phpMAE and uploads it into CloudObjects. Updates the configuration if necessary.')
  ...
  protected function execute(InputInterface $input, OutputInterface $output) {
    ...
    $validator->validateAsProvider(file_get_contents($this->fullName.'.php'));
