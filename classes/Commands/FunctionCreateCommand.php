...
class FunctionCreateCommand extends Command {
    ...
    protected function configure() {
      $this->setName('function:create')
        ->setDescription('Create a new function class for the phpMAE.')
        ...
        ->addOption('confjob', null, InputOption::VALUE_OPTIONAL, 'Calls "cloudobjects" to create a configuration job for the new function.', false);
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
      ...
      if (!file_exists($fullName.'.xml') || $input->getOption('force') !== false) {
        ...
        $content = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
          ...
          . "\n"
          . " <phpmae:FunctionClass rdf:about=\"".(string)$coid."\">\n"
          . "  <co:isVisibleTo rdf:resource=\"coid://cloudobjects.io/Vendor\" />\n"
          . " </phpmae:FunctionClass>\n"
          . "</rdf:RDF>";
      ...
      if (!file_exists($fullName.'.php') || $input->getOption('force') !== false) {
        ...
        $content = "<?php\n"
          ...
          . "use CloudObjects\PhpMAE\FunctionInterface;\n"
          . "\n"
          . "/**\n"
          . " * Implementation for ".(string)$coid."\n"
          . " */\n"
          . "class ".$name." implements FunctionInterface {\n"
          . "\n"
          . "  public function execute(ParameterBag \$parameters, Container \$dependencies) {\n"
